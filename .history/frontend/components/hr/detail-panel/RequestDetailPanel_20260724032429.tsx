    ...
    <div className="flex flex-col gap-8 rounded-lg p-8 border bg-[#FFFFFF] dark:bg-neutral-900 ">
      ...
      <div className="flex items-center justify-end gap-2">
        ...
        <Button
          disabled={!isPending}
          onClick={onApprove}
          className="flex p-4 bg-[#18181B] dark:bg-black dark:text-gray-200 rounded-md hover:bg-gray-800/80"
        >
          <Check className="size-3" />
          <p className="text-xs dark:text-gray-200 dark:hover:bg-neutral-900 font-medium leading-5 tracking-normal text-primary-foreground">
            Зөвшөөрөх
          </p>
        </Button>
      </div>
