        ...
        {filteredReqs.map((req) => {
          ...
          return (
            <button
              ...
              className={`flex items-start gap-3 py-4 text-left  rounded-md hover:bg-[#FFFFFF] transition-colors ${selectedId === req.id ? "bg-[#FFFFFF]" : ""}`}
            >
              <Avatar>
              ...
              <div className="flex flex-col gap-1 flex-1 min-w-0">
                <div className="flex gap-2">
                  <div className="flex justify-center items-center gap-1.5 text-sm font-medium leading-5 tracking-normal">
                    {req.user.username}
