  ...
  return (
    <div className="w-full flex flex-col rounded-md border border-[#E4E4E7] bg-white divide-x">
      <div className="w-full flex items-stretch bg-[#F4F4F5] text-xs font-semibold leading-4 tracking-normal text-center border-b border-[#E4E4E7] divide-x divide-gray-300">
        <p className="w-12 flex items-center justify-center py-2 px-1">№</p>
      ...
      <div className="flex flex-col divide-y divide-x divide-[#E4E4E7] bg-white">
        {employees.map((employee, index) => (
          <div
            key={employee.id}
            className="w-full flex items-stretch bg-[#F4F4F5] text-xs font-semibold leading-4 tracking-normal text-center divide-x divide-gray-300 "
          >
