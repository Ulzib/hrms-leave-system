      ...
      <div className="flex justify-between">
        <div className="flex">
          <Input
            ...
            className="ring-0 focus:ring-0 focus:outline-none text-sm bg-[#FFFFFF]"
          />
          <Button className="border-[#E4E4E7] border-dashed py-2 px-4 gap-2 rounded-md bg-[#FFFFFF] text-black">
            <PlusCircle />
