...
return(
    <Card className="flex items-center gap-4 px-6 py-4 rounded-xl">
        <div>{leave.user.profilePicture?(
            <Image src={leave.user.profilePicture} alt={leave.user.username} width={36} height={36}/>
        ):(
