    ...
    <div className="flex flex-col gap-2">
      ...
      >
        <ComboboxInput
          ...
          className="w-full bg-transparent outline-none border-none p-0 focus:ring-0 text-sm placeholder:text-muted-foreground"
        />
        <ComboboxContent>
          <ComboboxList>
            {filtered.length > 0 ? (
              filtered.map((manager) => (
                <ComboboxItem
                  ...
                  className="text-sm font-normal leading-5 tracking-normal py-1.5 px-2 "
                >
                  {manager.username}
                </ComboboxItem>
              ))
