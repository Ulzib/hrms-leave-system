...
//ognoog 2024/06/03 heltsiin formatar haruulna
...
const EmployeeTable = ({ employees, onPromoteClick }: EmployeeTableProps) => {
  return (
    <div className="w-full rounded-md border border-[#E4E4E7] bg-white ">
      <Table>
        <TableHeader>
          <TableRow className="text-sm font-semibold leading-4 tracking-normal divide-x divide-[#E4E4E7] bg-[#F4F4F5]">
            <TableHead>№</TableHead>
        ...
        <TableBody>
          {employees.map((employee, index) => (
            <TableRow
              key={employee.id}
              className="text-xs font-normal leading-4 tracking-normal divide-x divide-[#E4E4E7]"
            >
