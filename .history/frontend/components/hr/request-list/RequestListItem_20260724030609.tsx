...
const RequestListItem = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`relative flex items-center gap-3 p-4 text-left  rounded-md hover:bg-[#FFFFFF] dark:hover:bg-neutral-900 transition-colors ${isSelected ? "bg-[#FFFFFF] border" : ""}`}
    >
