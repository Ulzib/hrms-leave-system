...
const EmployeeTable = ({ employees, onPromoteClick }: EmployeeProps) => {
  return (
    <div className="w-full flex flex-col rounded-md border border-[#E4E4E7] bg-white divide-x">
      <div className="w-full flex items-stretch bg-[#F4F4F5] text-xl font-semibold leading-4 tracking-normal text-center border-b border-[#E4E4E7] divide-x divide-gray-300">
        <p className="w-12 flex items-center justify-center py-3">№</p>
        <p className="flex-1 flex items-center justify-center py-1 px-2">
          Нэр, Овог
        </p>
