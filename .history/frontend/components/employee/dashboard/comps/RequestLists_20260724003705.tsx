      ...
      {filteredLeaves.map((leave) => {
        ...
        return (
          <div key={leave.id} className="flex flex-col gap-1">
            <div className="flex items-center gap-2 text-base font-medium leading-7 tracking-normal ">
              {month}/{day}
            ...
            <Card className="flex-1  p-6 rounded-xl">
              <div className="flex flex-col gap-2 ">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm dark:text-gray-900/20 font-normal leading-5 tracking-normal ">
