...
const RequestDetailPanel = ({
  ...
  return (
    <div className="flex flex-col gap-8 rounded-lg p-8 border bg-[#FFFFFF] dark:bg-neutral-900 ">
      <div className="flex  justify-between">
        <div className="flex flex-col gap-2">
          <Badge className={getStatusColor(request.status)}>
            {getStatusLabel(request.status)}
          </Badge>
          <h4 className="text-xl dark:text-gray-200 font-semibold leading-7 tracking-[-2.5%]">
        ...
        <div className="mr-0">
          ...
          <p className="text-sm dark:text-gray-200 font-normal leading-[100%] tracking-normal">
      ...
      <div className="flex justify-between gap-4">
        <div className="w-full flex flex-col items-start gap-2">
          ...
          <p className="text-sm dark:text-gray-200 font-normal leading-5 tracking-normal">
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <p className=" text-sm dark:text-gray-200 font-normal leading-5 tracking-normal">
            {new Date(request.startDate).toLocaleTimeString("mn-MN", {
              hour: "2-digit",
              minute: "2-digit",
              hour12: false,
            })}
            -
            {new Date(request.endDate).toLocaleTimeString("mn-MN", {
              hour: "2-digit",
              minute: "2-digit",
              hour12: false,
            })}
      ...
      <div className="flex items-center justify-end gap-2">
        ...
        <Button
          disabled={!isPending}
          onClick={onApprove}
          className="flex p-4 bg-[#18181B] dark:bg-black dark:text-gray-200 rounded-md hover:bg-gray-800/80 dark:hover:bg-neutral-800"
        >
          <Check className="size-3" />
          <p className="text-xs dark:text-gray-200  font-medium leading-5 tracking-normal text-primary-foreground">
            Зөвшөөрөх
          </p>
        </Button>
      </div>
