...
const PickDate = ({ selectedDate, onDateChange }: PickDateProps) => {
  ...
  return (
    <Field className="w-72 dark:bg-neutral-900 dark:border-none rounded-md border border-border ">
      <Popover>
        <PopoverTrigger asChild>
          <Button
            variant="outline"
            className="flex justify-center py-5 font-normal dark:text-gray-200 border-none"
          >
            <CalendarIcon />
            {dateLabel}
          </Button>
