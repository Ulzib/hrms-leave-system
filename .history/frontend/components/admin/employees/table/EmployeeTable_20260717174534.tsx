...
const EmployeeTable = ({ employees, onPromoteClick }: EmployeeProps) => {
  return (
    <div className="w-full flex flex-col rounded-md border border-[#E4E4E7] bg-white divide-x">
      <div className="w-full flex items-center justify-between py-2 px-4 bg-[#F4F4F5] text-sm font-semibold leading-4 tracking-normal text-center border-x-[#E4E4E7] divide-x divide-gray-200 ">
        <p>№</p>
        <p>Нэр, Овог</p>
        <p>Албан тушаал</p>
        <p>Имэйл</p>
