...
const PendingRequestsList = ({
  ...
  return (
    ...
    <RequestPagination  currentPage={currentPage} totalPages={totalPages} startIndex={startIndex} pageSize={PAGE_SIZE} totalCount={totalCount} onPageChange={setCurrentPage}/>
  );
};
