...
const RequestListItem = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`relative flex items-center gap-3 p-4 text-left  rounded-md hover:bg-[#FFFFFF] dark:hover:bg-neutral-900 transition-colors ${isSelected ? "bg-[#FFFFFF] dark:bg-neutral-900 border" : ""}`}
    >
      ...
      <div className="flex flex-col gap-1 flex-1 min-w-0">
        <div className="flex items-center gap-1.5 ">
          <div className="text-sm dark:text-gray-200 font-medium leading-5 tracking-normal">
          ...
          {isUnread ? (
            ...
            <p className="text-xs dark:text-gray-200 font-normal leading-4 tracking-normal">
              {timeAgo}
            </p>
          )}
        </div>
        <div className="flex items-center gap-1 text-xs dark:text-gray-200 font-normal leading-4 tracking-normal truncate">
