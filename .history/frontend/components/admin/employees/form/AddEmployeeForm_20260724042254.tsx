  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        <Label
          htmlFor="username"
          className="text-sm dark:text-gray-200 font-medium leading-3.5 tracking-normal"
        >
          Нэр, Овог
        </Label>
        <Input
          ...
          className="text-xs font-normal leading-5 tracking-normal border-[#E4E4E7] p-3 rounded-md "
        />
      </div>
      <div className="flex flex-col gap-2">
        <Label
      ...
      <div className="flex flex-col gap-2">
        <Label className="text-sm dark:text-gray-200 font-medium leading-3.5 tracking-normal">
          Ажилд орсон огноо
        </Label>
      ...
      <div className="flex flex-col gap-2">
        ...
        <Select value={role} onValueChange={roleChange}>
          <SelectTrigger className="w-full text-xs p-3">
            <SelectValue placeholder="Сонгох" />
          </SelectTrigger>
          <SelectContent position="popper" sideOffset={4}>
            <SelectItem value="HR" className="text-xs dark:text-gray-200">
              Ахлах ажилтан болгох
            </SelectItem>
            <SelectItem value="EMPLOYEE" className="text-xs dark:text-gray-200">
              Ажилтан болгох
            </SelectItem>
          </SelectContent>
        </Select>
