    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className=" border-[#E4E4E7] p-8 gap-8 rounded-md">
        ...
        <AddEmployeeForm
          ...
          roleChange={setRole}
        />
        <DialogFooter className="bg-white dark:bg-neutral-900 border-none">
          <Button
            variant="outline"
            disabled={submit}
            onClick={handleClose}
          ...
          <Button
            ...
            className="py-4 px-6 gap-2 rounded-md hover:bg-gray-800/80 dark:hover:bg-neutral-300"
          >
            <p className="text-sm font-medium leading-5 tracking-normal dark:hover:text-gray-200">
              Нэмэх
            </p>
          </Button>
        </DialogFooter>
