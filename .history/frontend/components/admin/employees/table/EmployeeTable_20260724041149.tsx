...
const EmployeeTable = ({ employees, onPromoteClick }: EmployeeTableProps) => {
  return (
    <div className="w-full rounded-md border border-[#E4E4E7] bg-white dark:bg-neutral-900">
      <Table>
        <TableHeader>
          <TableRow className="text-sm dark:text-gray-200 font-semibold leading-4 tracking-normal divide-x divide-[#E4E4E7] dark:divide-gray-600 dark:border-gray-600 bg-[#F4F4F5] dark:bg-muted ">
            <TableHead>№</TableHead>
        ...
        <TableBody>
          {employees.map((employee, index) => (
            <TableRow
              key={employee.id}
              className="text-sm font-normal leading-4 tracking-normal divide-x divide-[#E4E4E7] dark:divide-gray-600 dark:text-gray-300"
            >
