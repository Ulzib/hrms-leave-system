...
const LeaveCard = ({ leave }: { leave: ApprovedLeave }) => {
  return (
    <div className="flex bg-white dark:bg-muted border border-border gap-4 px-6 py-5 rounded-md">
      ...
      <div className="flex flex-col gap-2 flex-1">
        <p className="text-sm dark:text-gray-200 font-medium leading-5 tracking-normal">
          {leave.user.username}
        </p>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <p className="text-sm text-black dark:text-gray-200 font-medium leading-5 tracking-normal">
              09:00 - 18:00
            </p>
          </div>
          ...
          <div className="flex items-center gap-1 text-muted-foreground">
            ...
            <p className="text-sm text-black dark:text-white font-medium leading-5 tracking-normal">
