...
const EmployeeTable = ({ employees, onPromoteClick }: EmployeeProps) => {
  return (
    <div className="w-full rounded-md border bg-white overflow-x-auto">
      {/* 2. "min-w-[1100px]" буюу хамгийн багадаа байх өргөнийг зааж өгнө */}
      <Table className="min-w-[1100px]">
        <TableHeader>
          <TableRow>
            ...
            <TableHead>Хүсэлт батлах ахлах ажилтан болгох</TableHead>
          </TableRow>
        </TableHeader>
      </Table>
    </div>
