import { Calendar, TagIcon, TimerIcon, X } from "lucide-react";
    ...
    <div className="flex flex-col gap-8 rounded-lg p-8 border bg-[#FFFFFF]">
      ...
      <div className="flex items-center justify-end gap-2">
        <Button
          ...
          disabled={!isPending}
          onClick={onReject}
          className="py-2 px-4 bg-[#F4F4F5] rounded-sm"
        >
          <X className="size-4" />
          <p className="text-3xl font-medium leading-5 tracking-normal">
            Татгалзах
          </p>
        </Button>
