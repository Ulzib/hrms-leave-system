    ...
    <div className="flex flex-col gap-8 rounded-lg p-8 border bg-[#FFFFFF]">
      ...
      <div className="flex items-center justify-end gap-2">
        <Button
          ...
          disabled={!isPending}
          onClick={onReject}
          className="py-2 px-4 bg-[#F4F4F5] rounded-md hover:bg-gray-200"
        >
          <X className="size-4" />
          <p className="flex text-sm font-medium leading-5 tracking-normal">
            Татгалзах
          </p>
        </Button>
        <Button
          disabled={!isPending}
          onClick={onApprove}
          className="flex py-2 px-4 bg-[#18181B] rounded-md hover:bg-gray-800/50"
        >
